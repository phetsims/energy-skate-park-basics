...
(5) Open in the browser: `http://localhost/energy-skate-park-basics/energy-skate-park-basics_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
...
(3) Open in the browser: `http://localhost/energy-skate-park-basics/build/adapted-from-phet/energy-skate-park-basics_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
