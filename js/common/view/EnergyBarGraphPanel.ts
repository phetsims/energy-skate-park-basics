...
export default class EnergyBarGraphPanel extends Panel {
  ...
  public constructor( model: EnergySkateParkModel, tandem: Tandem, providedOptions?: EnergyBarGraphPanelOptions ) {
    ...
    const energyBarGraph = new EnergyBarGraph( model.skater, model.barGraphScaleProperty, model.barGraphVisibleProperty, model.resetEmitter, model.preferencesModel.showPatternsProperty, tandem.createTandem( 'energyBarGraph' ), options.barGraphOptions );
