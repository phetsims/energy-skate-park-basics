...
define( function( require ) {
  ...
  var SkaterNode = require( 'ENERGY_SKATE_PARK/view/SkaterNode' );
  var TrackNode = require( 'ENERGY_SKATE_PARK/view/TrackNode' );
  var BackgroundNode = require( 'ENERGY_SKATE_PARK/view/BackgroundNode' );
  var EnergySkateParkBasicsControlPanel = require( 'ENERGY_SKATE_PARK/view/EnergySkateParkBasicsControlPanel' );
  var PlayPauseControlPanel = require( 'ENERGY_SKATE_PARK/view/PlayPauseControlPanel' );
  var PlaybackSpeedControl = require( 'ENERGY_SKATE_PARK/view/PlaybackSpeedControl' );
  var BarGraphNode = require( 'ENERGY_SKATE_PARK/view/BarGraphNode' );
  var PieChartNode = require( 'ENERGY_SKATE_PARK/view/PieChartNode' );
  var PieChartLegend = require( 'ENERGY_SKATE_PARK/view/PieChartLegend' );
  var GridNode = require( 'ENERGY_SKATE_PARK/view/GridNode' );
  var ResetAllButton = require( 'SCENERY_PHET/ResetAllButton' );
  var SceneSelectionPanel = require( 'ENERGY_SKATE_PARK/view/SceneSelectionPanel' );
