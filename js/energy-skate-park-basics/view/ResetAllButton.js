...
define( function( require ) {
  ...
  function ResetAllButton( callback, options ) {
    PushButton.call( this,
      new ResetAllImage( images.getImage( 'reset_button_up.png' ) ),
      new ResetAllImage( images.getImage( 'reset_button_over.png' ) ),
      new ResetAllImage( images.getImage( 'reset_button_down.png' ) ),
      new ResetAllImage( images.getImage( 'reset_button_disabled.png' ) ),
      callback, options );
  }
