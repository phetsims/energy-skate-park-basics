    ...
    init: function( model, controlPointGroupTandem, trackGroupTandem ) {
      ...
      var createControlPoint = function( x, y ) {
        ...
        if ( EnergySkateParkBasicsQueryParameters.DebugTracks === 1 ) {
          ...
          track = new Track( model, model.tracks, controlPoints, true, null, model.availableModelBoundsProperty, trackGroupTandem.createNextTandem() );
          track.physical = true;
        ...
        if ( EnergySkateParkBasicsQueryParameters.DebugTracks === 14 ) {
          ...
          var track1 = new Track( model, model.tracks, controlPoints1, true, null, model.availableModelBoundsProperty, trackGroupTandem.createNextTandem() );
          ...
          var track2 = new Track( model, model.tracks, controlPoints2, true, null, model.availableModelBoundsProperty, trackGroupTandem.createNextTandem() );
          ...
          var track3 = new Track( model, model.tracks, controlPoints3, true, null, model.availableModelBoundsProperty, trackGroupTandem.createNextTandem() );
        ...
        if ( EnergySkateParkBasicsQueryParameters.DebugTracks === 15 ) {
          ...
          ], true, null, model.availableModelBoundsProperty, trackGroupTandem.createNextTandem() );
